...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical register-form" action="addteam.do">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="重复输入密码" name="rpassword"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="手机" name="phone"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<input type="checkbox" name="tnc"/> 同意我们的强制规则
